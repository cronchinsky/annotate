...
/**
 * The main annotate configuration form
 *
...
class mod_annotate_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('annotatename', 'annotate'), array('size'=>'64'));
        ...
        $mform->addHelpButton('name', 'annotatename', 'annotate');
