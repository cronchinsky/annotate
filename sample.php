...
echo "<div class='annotate-sample'>";
echo $OUTPUT->heading("Sample $this_sample->name");
...
echo "<div class='annotate-action-link'><a href='view.php?a=$annotate->id'>Back to the Annotate Activity</a></div>";
echo "<div class='annotate-action-link'><a href='myanswers.php?aid=$annotate->id'>Class Chart</a></div>";
echo "<div class='annotate-action-link'><a href='sampleanswers.php?sid=$sid'>Participant Responses</a></div>";
echo "</div>";
echo "</div>";
echo $OUTPUT->footer();